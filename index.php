...
<html>
	...
	<body style="background-color:#B3D87D;">
	    ...
	    <nav class="baobao-login-head">
    		...
    		<a href="./reg.php">
        		<div style="float:right;margin-right:10px;">
    				<span class="baobao-span" >注册</span>
    			</div>
    		</a>
    		<a href="./login.php">
    			<div style="float:right;margin-right:30px;">
    				<span class="baobao-span" >登录</span>
    			</div>
			</a>
    	</nav>
    	<?php if($conf['notice_num']!=0){ ?>
		<div class="layui-carousel" id="notice" lay-filter="test4" style="align-items:center;left: 50%;margin-top:60px;transform: translate(-50%,0%);width:80%;border-radius:15px;background-color:transparent;height:300px;">
