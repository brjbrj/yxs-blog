				...
				<div class="baobao-title" style="border-radius:3px;">
				    <div style="display:inline-block; *display:inline; zoom:1;">
    					<div style="float:left;">
            				<span style="color:white;font-weight:bold;" class="iconfont icon-set"></span>
            			</div>
            			<div style="float:left;">
            				<span style="color:white;font-weight:bold;" >编辑器设置</span>
            			</div>
        			</div>
        		</div>
				<form class="layui-form" action="" style="margin-top:10px;">
					<div class="baobao-line-in">
						<div class="baobao-form-span" >
							<div style="font-weight:bold;"><span style="color:#fff;">编辑器高</span></div>
						</div>
					...
					<div class="baobao-line-in">
						<div class="baobao-form-span" >
							<div style="font-weight:bold;"><span style="color:#fff;">工具栏设置</span></div>
						</div>
						<div class="baobao-form-input">
					...
					<div class="baobao-line-in">
						<div class="baobao-form-span" >
							<div style="font-weight:bold;"><span style="color:#fff;">支持的字号</span></div>
						</div>
						<div class="baobao-form-input">
				    ...
				    <div class="baobao-line-in">
						<div class="baobao-form-span" >
							<div style="font-weight:bold;"><span style="color:#fff;">支持的行高</span></div>
						</div>
						<div class="baobao-form-input">
				    ...
				    <div class="baobao-line-in">
						<div class="baobao-form-span" >
							<div style="font-weight:bold;"><span style="color:#fff;">全屏功能</span></div>
						</div>
						<div class="baobao-form-input">
					...
					<div class="baobao-line-in">
						<div class="baobao-form-span" >
							<div style="font-weight:bold;"><span style="color:#fff;">base64保存图片</span></div>
						</div>
						<div class="baobao-form-input">
					...
					<div class="baobao-line-in">
						<div class="baobao-form-span" >
							<div style="font-weight:bold;"><span style="color:#fff;">上传图片到本地</span></div>
						</div>
						<div class="baobao-form-input">
					...
					<div class="baobao-line-in">
						<div class="baobao-form-span" >
							<div style="font-weight:bold;"><span style="color:#fff;">网络图片</span></div>
						</div>
						<div class="baobao-form-input">
					...
					<div class="baobao-line-in">
						<div class="baobao-form-span" >
							<div style="font-weight:bold;"><span style="color:#fff;">网络视频</span></div>
						</div>
						<div class="baobao-form-input">
					...
					<div class="baobao-line-in">
						<div class="baobao-form-span" >
							<div style="font-weight:bold;"><span style="color:#fff;">本地视频</span></div>
						</div>
						<div class="baobao-form-input">
                    ...
                    <div class="layui-tab-content" style="height:auto;margin:0;padding:0;text-align:center;">
                        ...
                        <div class="layui-tab-item">
                            <form class="layui-form" action="" style="margin-top:10px;">
            					<div class="baobao-line-in">
            						<div class="baobao-form-span" >
            							<div style="font-weight:bold;"><span style="color:#fff;">大小数值</span></div>
            						</div>
            						<div class="baobao-form-input">
            					...
            					<div class="baobao-line-in">
            						<div class="baobao-form-span" >
            							<div style="font-weight:bold;"><span style="color:#fff;">大小单位</span></div>
            						</div>
            						<div class="baobao-form-input">
            					...
            					<div class="baobao-line-in">
            						<div class="baobao-form-span" >
            							<div style="font-weight:bold;"><span style="color:#fff;">视频类型</span></div>
            						</div>
            						<div class="baobao-form-input">
                        ...
                        <div class="layui-tab-item">
                            <form class="layui-form" action="" style="margin-top:10px;">
            					...
            					<div class="baobao-line-in">
            						<div class="baobao-form-span" >
            							<div style="font-weight:bold;"><span style="color:#fff;">图片类型</span></div>
            						</div>
            						<div class="baobao-form-input">
                        ...
                        <div class="layui-tab-item">
                            <form class="layui-form" action="" style="margin-top:10px;">
            					<div class="baobao-line-in">
            						<div class="baobao-form-span" >
            							<div style="font-weight:bold;"><span style="color:#fff;">图片Alt</span></div>
            						</div>
            						<div class="baobao-form-input">
            					...
            					<div class="baobao-line-in">
            						<div class="baobao-form-span" >
            							<div style="font-weight:bold;"><span style="color:#fff;">图片链接</span></div>
            						</div>
            						<div class="baobao-form-input">
