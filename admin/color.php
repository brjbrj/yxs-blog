	...
	<script>
	    layui.use('table', function(){
            ...
            var tableIns=table.render({
                elem: '#demo'
                ,url:'./data.php?act='+<?php if($mod=="admin")echo "'admin'";elseif($mod=="user") echo "'user'";elseif($mod=="public")echo "'public'";?>+'color'
                ,toolbar: '#toolbarDemo'
                ,cellMinWidth: 80
                ,cellMinHeight: 50
                ,title: '颜色数据表'
