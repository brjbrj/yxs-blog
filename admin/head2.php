...
echo '
	<head>
		...
		<style>
			...
			.baobao-pannel .baobao-pannel-body::-webkit-scrollbar-track
			{
				-webkit-box-shadow: inset 0 0 5px rgba(0,0,0,0.2);
				border-radius: 0;
    		...
    		.baobao-textarea::-webkit-scrollbar-track
    		{
    			-webkit-box-shadow: inset 0 0 5px rgba(0,0,0,0.2);
    			border-radius: 0;
    			background: rgba(0,0,0,0.1);
			...
			.baobao-nav::-webkit-scrollbar-track
			{
				-webkit-box-shadow: inset 0 0 5px rgba(0,0,0,0.2);
				border-radius: 0;
				background: rgba(0,0,0,0.1);
			...
			.baobao-nav-show,.baobao-nav-item>a:focus
			{
				color:'.$colors["11"].';
				background:'.$colors["8"].';
			}
			...
			<ul>
				...
				<li '.this($act,"color").' class="baobao-nav-item" style="line-height:50px;">
					...
					<ul >
	                    ...
	                    <li><a href="./color.php?mod=public"><span>一般颜色管理</span></a></li>
	                </ul>
				</li>
