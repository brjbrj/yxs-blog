...
?>
	<style>
		...
		.baobao-tab
		{
			background-color: <?php echo $colors['13'];?>;
			color:<?php echo $colors['14'];?>;
			cursor: pointer;
		}
		.baobao-tab:hover
		{
			background-color: <?php echo $colors['15'];?>;
		...
		<div class="baobao-pannel-body">
			<div class="baobao-width-406080" style="margin:0 auto;">
				...
				<div class="baobao-title" style="border-radius:3px;">
					<span style="font-weight:bold;">账号配置</span>
				<div>
				<form class="baobao-form">
					...
					<div class="baobao-line-item" >
						<input class="baobao-button" type="button" id="test" value="发送测试">
					</div>
				</form>
				<?php }else{?>
				<div class="baobao-title" style="border-radius:3px;">
					<span style="font-weight:bold;">发信模板</span>
				<div>
