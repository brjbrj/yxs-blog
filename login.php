			...
			<div class="baobao-show">
				<div class="baobao-width-406080 baobao-x-center" style="float: none;padding-top:10px;">
					...
					<form name="login" action="##" method="post" class="baobao-form">
						...
						<?php }?>
						<div class="baobao-inline" style="height:50px;background-color:#1A94E6;">
							<div style="float:left;width:100%;"><input type="button" id="submit" name="submit"  style="height:100%;font-weight:bold;font-size:18px;color:#fff;background:linear-gradient(to right,#226DDD,#94E0F3,#226DDD);border:none;width:100%;cursor:pointer;" value="登录"></div>
						</div>
					</form>
					<hr>
					<div class="baobao-contain baobao-font-title" style="float:none;<?php echo background_image_2(90,'#1A94E6','#94E0F3','#1A94E6');?>border-radius:0% 0% 10px 10px;font-size:10px;">
						<a href="./find.php"><span style="color:#fff;">忘记密码</span></a><a href="./reg.php"><span style="color:#fff;margin-left:30px;">没有账号,前往注册</span></a>
					</div>
				</div>
			</div>
		</div>
