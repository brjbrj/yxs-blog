				...
				<div class="baobao-width-406080 baobao-x-center" style="float: none;padding-top:10px;">
					...
					<form name="login" action="##" method="post" class="baobao-form">
						...
						<div class="baobao-inline" style="height:50px;background-color:#1A94E6;">
							<div style="float:left;width:100%;"><input type="button" id="submit_1" name="submit_1"  style="height:100%;font-weight:bold;font-size:18px;color:#fff;background:linear-gradient(to right,#226DDD,#94E0F3,#226DDD);border:none;width:100%;cursor:pointer;" value="确认"></div>
						</div>
					</form>
					<?php }else if($do==1){?>
					<form name="login" action="##" method="post" class="baobao-form">
						...
						<hr>
						<div class="baobao-inline" style="height:50px;background-color:#1A94E6;">
							<div style="float:left;width:100%;"><input type="button" id="submit_2" name="submit_2"  style="height:100%;font-weight:bold;font-size:18px;color:#fff;background:linear-gradient(to right,#226DDD,#94E0F3,#226DDD);border:none;width:100%;cursor:pointer;" value="确认"></div>
						</div>
					</form>
					<?php }else if($do==2){?>
					<form name="login" action="##" method="post" class="baobao-form">
						...
						<hr>
						<div class="baobao-inline" style="height:50px;background-color:#1A94E6;">
							<div style="float:left;width:100%;"><input type="button" id="submit_3" name="submit_3"  style="height:100%;font-weight:bold;font-size:18px;color:#fff;background:linear-gradient(to right,#226DDD,#94E0F3,#226DDD);border:none;width:100%;cursor:pointer;" value="下一步"></div>
						</div>
					</form>
					<?php }else if($d0==3){?>
					<form name="login" action="##" method="post" class="baobao-form">
						...
						<hr>
						<div class="baobao-inline" style="height:50px;background-color:#1A94E6;">
							<div style="float:left;width:100%;"><input type="button" id="submit_4" name="submit_4"  style="height:100%;font-weight:bold;font-size:18px;color:#fff;background:linear-gradient(to right,#226DDD,#94E0F3,#226DDD);border:none;width:100%;cursor:pointer;" value="确定"></div>
						</div>
					</form>
					<?php }else if($do==4){?>
					    <form name="login" action="##" method="post" class="baobao-form">
						...
						<hr>
						<div class="baobao-inline" style="height:50px;background-color:#1A94E6;">
							<div style="float:left;width:100%;"><input type="button" id="submit_4" name="submit_4"  style="height:100%;font-weight:bold;font-size:18px;color:#fff;background:linear-gradient(to right,#226DDD,#94E0F3,#226DDD);border:none;width:100%;cursor:pointer;" value=">>完成<<"></div>
						</div>
					</form>
					<?php }?>
					<hr>
