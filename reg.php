			...
			<div class="baobao-show">
				<div class="baobao-width-406080 baobao-x-center" style="float: none;padding-top:30px;">
					...
					<form name="login" action="##" method="post" class="baobao-form">
						...
						<?php }?>
						<div class="baobao-inline" style="height:50px;background-color:#1A94E6;">
							<div style="float:left;width:100%;"><input type="button" id="submit" name="submit"  style="height:100%;font-weight:bold;font-size:18px;color:<?php echo $colors['89'];?>;<?php echo background_image_2(90,$colors['92'],$colors['91'],$colors['92']);?>border:none;width:100%;cursor:pointer;" value="注册"></div>
						</div>
					</form>
					<hr>
